...
ansible-playbook -i localhost, $PLAYS_ROOT/bootstrap.yml 
ansible-playbook -i localhost, $PLAYS_ROOT/usrstrap.yml 
ansible-playbook -i localhost, $PLAYS_ROOT/localstrap.yml 
